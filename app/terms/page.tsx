        ...
        <main className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground">
            ...
            <div className="max-w-4xl mx-auto px-6 pt-32 pb-20">
                ...
                <div className="p-8 rounded-2xl border border-border bg-card/50 backdrop-blur-sm space-y-8 text-pretty">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-outfit font-bold border-l-4 border-primary pl-4">2. Café Responsibilities</h3>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-outfit font-bold border-l-4 border-primary pl-4">3. Customer Use</h3>
                        <ul className="list-disc ml-5 space-y-2 text-muted-foreground">
                            <li>Provide accurate mobile numbers</li>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-outfit font-bold border-l-4 border-primary pl-4">4. Availability</h3>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-outfit font-bold border-l-4 border-primary pl-4">5. Limitation of Liability</h3>
                        <p className="text-muted-foreground">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-xl font-outfit font-bold border-l-4 border-primary pl-4">6. Termination</h3>
                        <p className="text-muted-foreground">
                            We may suspend or terminate access if terms are violated, the service is misused, or as required by law.
                        </p>
                    </div>

                    <div className="space-y-4">
                        <h3 className="text-xl font-outfit font-bold border-l-4 border-primary pl-4">7. Governing Law</h3>
                        <p className="text-muted-foreground">
